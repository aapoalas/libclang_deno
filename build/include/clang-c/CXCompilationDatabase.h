 ...
 */
CINDEX_LINKAGE CXCompilationDatabase clang_CompilationDatabase_fromDirectory(
 ...
 */
CINDEX_LINKAGE CXCompileCommands clang_CompilationDatabase_getCompileCommands(
